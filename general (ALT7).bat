...
set TCP_STRATEGY=--ip-id=zero --dpi-desync=syndata --dpi-desync-fooling=badseq,hopbyhop2 --dpi-desync-badseq-increment=2 --dpi-desync-repeats=11 --dpi-desync-fake-tls-mod=rnd,dupsid,sni=%FAKE_SNI%,padencap
