...
--filter-tcp=80,443 --hostlist="%LISTS%list-general.txt" --hostlist="%LISTS%list-general-user.txt" --hostlist-exclude="%LISTS%list-exclude.txt" --hostlist-exclude="%LISTS%list-exclude-user.txt" --ipset-exclude="%LISTS%ipset-exclude.txt" --ipset-exclude="%LISTS%ipset-exclude-user.txt" --dpi-desync=fake --dpi-desync-badseq-increment=0 --dpi-desync-badack-increment=1 --dpi-desync-fake-tls="%BIN%tls_clienthello_hcaptcha_com.bin" --dpi-desync-fake-http="%BIN%tls_clienthello_hcaptcha_com.bin" --new ^
...
--filter-tcp=80,443,8443 --ipset="%LISTS%ipset-all.txt" --hostlist-exclude="%LISTS%list-exclude.txt" --hostlist-exclude="%LISTS%list-exclude-user.txt" --ipset-exclude="%LISTS%ipset-exclude.txt" --ipset-exclude="%LISTS%ipset-exclude-user.txt" --dpi-desync=fake --dpi-desync-badseq-increment=0 --dpi-desync-badack-increment=1 --dpi-desync-fake-tls="%BIN%tls_clienthello_hcaptcha_com.bin" --dpi-desync-fake-http="%BIN%tls_clienthello_hcaptcha_com.bin" --new ^
--filter-tcp=%GameFilterTCP% --ipset="%LISTS%ipset-all.txt" --ipset-exclude="%LISTS%ipset-exclude.txt" --ipset-exclude="%LISTS%ipset-exclude-user.txt" --dpi-desync=fake --dpi-desync-badseq-increment=0 --dpi-desync-badack-increment=1 --dpi-desync-fake-tls="%BIN%tls_clienthello_hcaptcha_com.bin" --dpi-desync-fake-http="%BIN%tls_clienthello_hcaptcha_com.bin" --new ^
