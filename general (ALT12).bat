...
--filter-udp=19294-19344,50000-50100 --filter-l7=discord,stun --dpi-desync=fake --dpi-desync-fake-discord="%BIN%stun.bin" --dpi-desync-fake-discord="%BIN%quic_initial_steamcommunity_com.bin" --dpi-desync-fake-stun="%BIN%quic_initial_steamcommunity_com.bin" --dpi-desync-repeats=3 --new ^
