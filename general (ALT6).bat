...
set UDP_STRATEGY=--dpi-desync=fake --dpi-desync-ttl=8 --dpi-desync-repeats=16 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp="%FAKE_UDP%" --dpi-desync-cutoff=n8
set TCP_STRATEGY=--ip-id=zero --dpi-desync=split2 --dpi-desync-repeats=2 --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-fooling=badseq,hopbyhop2 --dpi-desync-split-seqovl-pattern="%FAKE_TLS%" --dpi-desync-fake-tls="%FAKE_TLS%" --dpi-desync-fake-tls-mod=rnd,dupsid,sni=%FAKE_SNI%,padencap
