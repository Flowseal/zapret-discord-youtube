...
if not exist "%BIN%stun.bin" goto :missing_bin
if not exist "%BIN%tls_clienthello_4pda_to.bin" goto :missing_bin
if not exist "%BIN%tls_clienthello_max_ru.bin" goto :missing_bin
