...
Открывается ли сайт YouTube?
- Если YouTube не открывается, значит необходимо использовать другую стратегию. Почините сначала ютуб, или хотя бы сделайте чтобы сайт YouTube открывался.
- Если YouTube открывается, то проверьте Discord в браузере: https://discord.com/app. В браузере работает? Если да, то так прямо в браузере и пользуйтесь.
