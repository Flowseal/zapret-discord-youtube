...
- [**`service.bat`**](./service.bat) - установка в автозапуск и другие функции:
  ...
  **После переключения требуется перезапуск стратегии.**  
  ...
  - **`Extra Settings`** — расширенное меню тонкой настройки и подмены фейк-пейлоадов для продвинутых пользователей. Позволяет кастомизировать фейк-пакеты отдельно по группам стратегий или сбросить их к заводским 
