...
- Убедитесь что вы настроили [Secure DNS](#-быстрый-старт).
...
- Если Discord и в браузере не работает, убедитесь что вы настроили [Secure DNS](#-быстрый-старт), и после этого ещё раз пробуйте все стратегии. Бывает такое, что на одной стратегии YouTube работает, а Discord нет.
