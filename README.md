...
1. Включите Secure DNS
    ...
    * Если у вас роутер Keenetic, зайдите в интерфейс роутера и убедитесь что включена опция "Транзит запросов". Отключение этой опции может привести к проблемам при настройке и использовании Secure DNS на компьютере
