...
> Yandex Browser НЕ является лучшим браузером для использования в паре с zapret. В нем может корректно НЕ работать Secure DNS, требуемый для работы zapret
